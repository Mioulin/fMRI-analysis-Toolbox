function ort_rdmSet = fmri_helper_orthogonaliseModelRDMs(rdmSet)
	%% ORTRDMSET = fmri_helper_orthogonaliseModelRDMs(RDMSET)
	%
    ...
    for modID=1:size(rdmSet,1)
        ...
        % mean-center RDM
        rdmVects(:,modID)=rdmVects(:,modID)-nanmean(rdmVects(:,modID));
    end
