...
function [betasNew,labelsNew] = fmri_rsa_helper_betasInRewSpace(betas,labels,rewCode)
  %% [betasNew,labelsNew] = fmri_rsa_helper_betasInRewSpace(betas,labels,rewCode)
  %
